...
def test_health_reports_phase21_runtime_boundary():
    ...
    assert payload["current_phase"] == "Phase 23 - Runtime Readiness Orchestration / Smoke Check CI Gate"
    assert payload["latest_completed_phase"] == "Phase 22 - FastAPI Lifespan Migration / Startup Contract Hardening Gate"
