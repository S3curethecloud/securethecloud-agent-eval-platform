...
grep -q '"current_phase": "Phase 21 - Runtime State Reconciliation / API Smoke Evidence Gate"' /tmp/agent_eval_health.json
grep -q '"latest_completed_phase": "Phase 20 - Offline Resilience Validation Evidence"' /tmp/agent_eval_health.json
